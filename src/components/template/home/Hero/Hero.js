        ...
        <div className="container">
            <div className="block text-center mx-auto max-w-[800px] py-16">
                <div className="flex justify-center text-center rounded-[50%] bg-primary p-2 w-[200px] h-[200px] mx-auto duration-300 hover:bg-secondary-100 hover:scale-120">
                    ...
                    <h1 className="block mt-8 font-roboto-black text-3xl md:text-5xl text-primary">Welcome to My Website</h1>
                    <p className="block mt-4 font-roboto-bold sm:text-md  md:text-base text-text-200">I'm a passionate professional showcasing my work and expertise</p>
